...
public class CustomerServiceImpl implements CustomerService {
	...
	@KafkaListener(topics = "customerDetail", groupId = "group_json", containerFactory = "userKafkaListenerFactory")
	public String updateOrderStatus(Order order) throws CustomerException {

		logger.info("message successfully readed from order service using kafka");
